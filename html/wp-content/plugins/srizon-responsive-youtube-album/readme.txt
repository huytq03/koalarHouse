...
1. Upload srizon-responsive-youtube-album folder to the `/wp-content/plugins/` directory (alternatively use upload option on 'Plugins->Add New' sub-menu and upload the zip file)
